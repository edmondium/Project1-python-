...
c     --------
      ...
      implicit none
      real_dp, intent(in) :: d(:)
      real_dp             :: diagonal(size(d),size(d))
      integer             :: i
      diagonal = 0
      do i = 1,size(d)
        diagonal(i,i) = d(i)
...
c     --------
      ...
      real_dp              :: matmat_dpdp(nint(sqrt(0.25d0+2*size(mat1))-0.5d0),
     &                                    nint(sqrt(0.25d0+2*size(mat1))-0.5d0))
      ...
      complex_dp              :: matmat_dpzp(nint(sqrt(0.25d0+2*size(mat1))-0.5d0),
     &                                       nint(sqrt(0.25d0+2*size(mat1))-0.5d0))
      ...
      complex_dp              :: matmat_zpdp(nint(sqrt(0.25d0+2*size(mat1))-0.5d0),
     &                                       nint(sqrt(0.25d0+2*size(mat1))-0.5d0))
      real_dp,    allocatable :: vecr(:),veci(:)
      ...
      complex_dp              :: matmat_zpzp(nint(sqrt(0.25d0+2*size(mat1))-0.5d0),
     &                                       nint(sqrt(0.25d0+2*size(mat1))-0.5d0))
      ...
      implicit none
      real_dp, intent(in)  :: mat1(:),mat2(:,:)
      real_dp              :: matmat_dpdm(size(mat2,1),size(mat2,2))
      real_dp, allocatable :: vec(:),vec2(:)
      integer              :: nn,n,i,n2
      ...
      implicit none
      real_dp, intent(in)  :: mat1(:,:),mat2(:)
      real_dp              :: matmat_dmdp(size(mat1,1),size(mat1,2))
      real_dp, allocatable :: vec(:),vec2(:)
      integer              :: nn,n,i,n1
      ...
      implicit none
      real_dp, intent(in) :: mat1(:,:),mat2(:,:)
      real_dp             :: matmat_dmdm(size(mat1,1),size(mat2,2))
      integer             :: n1,n,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,2)
      call check_dim(shape(mat2),[n,n2],'mat2',__LINE__)
      call dgemm('N','N',n1,n2,n,1d0,mat1,n1,mat2,n,0d0,matmat_dmdm,n1)
      ...
      real_dp,    intent(in)  :: mat1(:)
      complex_dp, intent(in)  :: mat2(:,:)
      complex_dp              :: matmat_dpzm(size(mat2,1),size(mat2,2))
      real_dp,    allocatable :: vecr(:),veci(:)
      complex_dp, allocatable :: vec2(:)
      integer                 :: nn,n,n2,i
      ...
      real_dp,    intent(in)  :: mat1(:,:)
      complex_dp, intent(in)  :: mat2(:)
      complex_dp              :: matmat_dmzp(size(mat1,1),size(mat1,2))
      ...
      real_dp,    intent(in) :: mat1(:,:)
      complex_dp, intent(in) :: mat2(:,:)
      complex_dp             :: matmat_dmzm(size(mat1,1),size(mat2,2))
      ...
      complex_dp, intent(in)  :: mat1(:)
      real_dp,    intent(in)  :: mat2(:,:)
      complex_dp              :: matmat_zpdm(size(mat2,1),size(mat2,2))
      complex_dp, allocatable :: vec(:),vec2(:)
      integer                 :: nn,n,i,n2
      n  = size(mat2,1) ; nn = n*(n+1)/2 ; allocate ( vec(n),vec2(n) )
      n2 = size(mat2,2)
      ...
      complex_dp, intent(in)  :: mat1(:,:)
      real_dp,    intent(in)  :: mat2(:)
      complex_dp              :: matmat_zmdp(size(mat1,1),size(mat1,2))
      complex_dp, allocatable :: vec1(:)
      real_dp,    allocatable :: vecr(:),veci(:)
      integer                 :: nn,n,n1,i
      ...
      complex_dp, intent(in) :: mat1(:,:)
      real_dp,    intent(in) :: mat2(:,:)
      complex_dp             :: matmat_zmdm(size(mat1,1),size(mat2,2))
c      real_dp                :: matr(size(mat1,1),size(mat2,2)),mati(size(mat1,1),size(mat2,2))
      ...
      n2 = size(mat2,2)
      call check_dim(shape(mat2),[n,n2],'mat2',__LINE__)
      call dgemm('N','N',2*n1,n2,n,1d0,mat1,2*n1,mat2,n,0d0,matmat_zmdm,2*n1)
...
c      matmat_zmdm = matr + (0d0,1d0) * mati
      ...
      implicit none
      complex_dp, intent(in)  :: mat1(:),mat2(:,:)
      complex_dp              :: matmat_zpzm(size(mat2,1),size(mat2,2))
      complex_dp, allocatable :: vec(:),vec2(:)
      integer                 :: nn,n,i,n2
      n  = size(mat2,1) ; nn = n*(n+1)/2 ; allocate ( vec(n),vec2(n) )
      n2 = size(mat2,2)
      ...
      implicit none
      complex_dp, intent(in)  :: mat1(:,:),mat2(:)
      complex_dp              :: matmat_zmzp(size(mat1,1),size(mat1,2))
      complex_dp, allocatable :: vec(:),vec2(:)
      integer                 :: nn,n,i,n1
      n  = size(mat1,2) ; nn = n*(n+1)/2 ; allocate ( vec(n),vec2(n) )
      n1 = size(mat1,1)
      ...
      implicit none
      complex_dp, intent(in) :: mat1(:,:),mat2(:,:)
      complex_dp             :: matmat_zmzm(size(mat1,1),size(mat2,2))
      integer                :: n1,n,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,2)
...
c     --------
      ...
      function macmat_dmdm(mat1,mat2)
      implicit none
      real_dp, intent(in) :: mat1(:,:),mat2(:,:)
      real_dp             :: macmat_dmdm(size(mat1,2),size(mat2,2))
      integer             :: n1,n,n2
      n1 = size(mat1,2)
      n  = size(mat1,1)
      n2 = size(mat2,2)
      call check_dim(shape(mat2),[n,n2],'mat2',__LINE__)
      call dgemm('C','N',n1,n2,n,1d0,mat1,n,mat2,n,0d0,macmat_dmdm,n1)
      end function macmat_dmdm

      function macmat_dmzm(mat1,mat2)
      implicit none
      real_dp,    intent(in) :: mat1(:,:)
      complex_dp, intent(in) :: mat2(:,:)
      complex_dp             :: macmat_dmzm(size(mat1,2),size(mat2,2))
      ...
      macmat_dmzm = matr + (0d0,1d0) * mati
      end function macmat_dmzm

      function macmat_zmdm(mat1,mat2)
      implicit none
      complex_dp, intent(in) :: mat1(:,:)
      real_dp,    intent(in) :: mat2(:,:)
      complex_dp             :: macmat_zmdm(size(mat1,2),size(mat2,2))
      real_dp                :: matr(size(mat1,2),size(mat2,2)),mati(size(mat1,2),size(mat2,2))
      integer                :: n,n1,n2
      n1 = size(mat1,2)
      n  = size(mat1,1)
      ...
      macmat_zmdm = matr - (0d0,1d0) * mati
      end function macmat_zmdm

      function macmat_zmzm(mat1,mat2)
      implicit none
      complex_dp, intent(in) :: mat1(:,:),mat2(:,:)
      complex_dp             :: macmat_zmzm(size(mat1,2),size(mat2,2))
      integer                :: n,n1,n2
      n1 = size(mat1,2)
      n  = size(mat1,1)
      n2 = size(mat2,2)
      call check_dim(shape(mat2),[n,n2],'mat2',__LINE__)
      call zgemm('C','N',n1,n2,n,(1d0,0d0),mat1,n,mat2,n,(0d0,0d0),macmat_zmzm,n1)
      end function macmat_zmzm

c     --------

      function matmac_dmdm(mat1,mat2)
      implicit none
      real_dp, intent(in) :: mat1(:,:),mat2(:,:)
      real_dp             :: matmac_dmdm(size(mat1,1),size(mat2,1))
      integer             :: n1,n,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,1)
      call check_dim(shape(mat2),[n2,n],'mat2',__LINE__)
      call dgemm('N','C',n1,n2,n,1d0,mat1,n1,mat2,n2,0d0,matmac_dmdm,n1)
      end function matmac_dmdm

      function matmac_dmzm(mat1,mat2)
      implicit none
      real_dp,    intent(in) :: mat1(:,:)
      complex_dp, intent(in) :: mat2(:,:)
      complex_dp             :: matmac_dmzm(size(mat1,1),size(mat2,1))
      integer                :: n,n1,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,1)
      call check_dim(shape(mat2),[n2,n],'mat2',__LINE__)
      call dgemm('N','C',n1,2*n2,n,1d0,mat1,n1,mat2,2*n2,0d0,matmac_dmzm,n1)
      do n = 1,n2
        call redistribute_cvec(matmac_dmzm(:,n),n1)
      enddo
      end function matmac_dmzm

      function matmac_zmdm(mat1,mat2)
      implicit none
      complex_dp, intent(in) :: mat1(:,:)
      real_dp,    intent(in) :: mat2(:,:)
      complex_dp             :: matmac_zmdm(size(mat1,1),size(mat2,1))
      integer                :: n,n1,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,1)
      call check_dim(shape(mat2),[n,n2],'mat2',__LINE__)
      call dgemm('N','C',2*n1,n2,n,1d0,mat1,2*n1,mat2,n2,0d0,matmac_zmdm,2*n1)
      end function matmac_zmdm

      function matmac_zmzm(mat1,mat2)
      implicit none
      complex_dp, intent(in) :: mat1(:,:),mat2(:,:)
      complex_dp             :: matmac_zmzm(size(mat1,1),size(mat2,1))
      integer                :: n1,n,n2
      n1 = size(mat1,1)
      n  = size(mat1,2)
      n2 = size(mat2,1)
      call check_dim(shape(mat2),[n2,n],'mat2',__LINE__)
      call zgemm('N','C',n1,n2,n,(1d0,0d0),mat1,n1,mat2,n2,(0d0,0d0),matmac_zmzm,n1)
      end function matmac_zmzm
...
c     --------
      ...
      function which_ranges(l1,l2,r1,r2)
      implicit none
