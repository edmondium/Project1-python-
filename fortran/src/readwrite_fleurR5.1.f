c Version for FLEUR (FleurMaX Release 5 version 32)
c
c -------------------------------------------------
c
...
# include "cppmacro.h"
      ...
      character(31),  parameter     :: dftlong    = 'FleurMaX Release 5.1 version 34'
      character(9),   parameter     :: dftshort   = 'fleurR5.1'
      character(10),  parameter     :: file_wavef = 'eig_gw.hdf'
