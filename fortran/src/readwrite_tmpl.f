...
c Name of DFT program (PROG)
      character(33), parameter :: dftlong    = 'PROG full name and version number'
      character(4),  parameter :: dftshort   = 'PROG' ! short name to be queried (e.g., in shell scripts)
      character(27), parameter :: file_wavef = 'FILE with wavefunction data' ! name of file holding wavefunction data
